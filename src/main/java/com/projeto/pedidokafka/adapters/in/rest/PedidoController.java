...
public class PedidoController {
  ...
  public PedidoController(
          EnviarPedidoUseCase enviarPedidoUseCase,
  ...
  public List<PedidoResponse> listarPedidos() {
    return consultarPedidoUseCase.buscarTodos()
            .stream()
  ...
  public PedidoResponse buscarPorId(@PathVariable String id) {
    return PedidoResponseMapper.toResponse(
            consultarPedidoUseCase.buscarPorId(id)
    );
  }
}
